...
__ALL__ = [ 'colored', 'colored2', 'colored3' ]
...
def colored2(text, color=None, on_color=None, attrs=None):
    """Colorize text.
...
def colored3(text, color=None, on_color=None, attrs=None):
    """Colorize text.
